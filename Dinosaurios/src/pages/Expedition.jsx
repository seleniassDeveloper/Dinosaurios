      ...
      >
        <div className="container">
          <h1 className="display-4 fw-extrabold mb-3 text-white lh-tight">
            {t("discovery.hero.title2").toUpperCase()} <br />
            {/* {t("discovery.hero.title1").toUpperCase()} */}
          </h1>
          <h2 className="h5 text-white-50 fw-semibold mb-3">
            {/* {t("discovery.hero.subtitle_line1")} <br /> */}
            {t("discovery.hero.subtitle_line2")}
          </h2>
          <p className="lead text-white mb-0">{t("discovery.hero.lead")}</p>
        </div>
      </section>
        ...
        <div className="row align-items-start g-5">
          <div className="col-lg-6">
            ...
            <div className="mt-4 text-body-secondary">
              <p dangerouslySetInnerHTML={{ __html: t("discovery.maip.p1") }} />
              <p dangerouslySetInnerHTML={{ __html: t("discovery.maip.p2") }} />
              <p dangerouslySetInnerHTML={{ __html: t("discovery.maip.p3") }} />
              <p
                className="mb-0"
                dangerouslySetInnerHTML={{ __html: t("discovery.maip.p4") }}
              />
            </div>
          </div>
        ...
        <div className="row align-items-start g-5">
          ...
          <div className="col-lg-6">
            ...
            <div className="text-body-secondary">
              <p
                dangerouslySetInnerHTML={{ __html: t("discovery.notob.p1") }}
              />
              <p
                dangerouslySetInnerHTML={{ __html: t("discovery.notob.p2") }}
              />
              <p
                dangerouslySetInnerHTML={{ __html: t("discovery.notob.p3") }}
              />
              {t("discovery.notob.p4") && (
                <p
                  className="mb-2"
                  dangerouslySetInnerHTML={{ __html: t("discovery.notob.p4") }}
                />
              )}
            </div>
          </div>
